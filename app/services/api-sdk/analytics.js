...
export default Ember.Service.extend({
   ...
   * in the return value.
   * @returns { UserQuestionsResult[] }
   */
  getCollectionResults: function (collectionId) {
    const response = [
    ...
    // TODO: Replace this with the correct server endpoint calls
    function callToServerEndPoint(collectionId) {
      return new Ember.RSVP.Promise(function (resolve, reject) {
        if (collectionId) {
          resolve(response);
        } else {
          reject('getCollectionResults: CollectionId parameter must be defined');
        }
      });
    }
    ...
    function callToServerEndPoint(collectionId) {
      return new Ember.RSVP.Promise(function (resolve, reject) {
        if (collectionId) {
          ...
          reject('isReportLive: CollectionId parameter must be defined');
        }
      });
    }
