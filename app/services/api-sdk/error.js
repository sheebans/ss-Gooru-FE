...
export default Ember.Service.extend({
  ...
  init: function () {
    ...
    this.set('errorSerializer', ErrorSerializer.create(Ember.getOwner(this).ownerInjection()));
    this.set('errorAdapter', ErrorAdapter.create(Ember.getOwner(this).ownerInjection()));
  },
  ...
  createError: function (error) {
    ...
    return new Ember.RSVP.Promise(function (resolve, reject) {
      ...
      service.get('errorAdapter').createError({body: errorContent})
        .then(resolve, reject);
    });
  }
