...
export default Ember.Service.extend({
  ...
  init: function () {
    ...
    this.set('notificationAdapter', NotificationAdapter.create(Ember.getOwner(this).ownerInjection()));
  },
  ...
  fetchNotifications: function(pagination, resetPagination = false) {
    ...
    return new Ember.RSVP.Promise(function(resolve, reject) {
      service.get('notificationAdapter').fetchNotifications(pagination, resetPagination)
        .then(function(response) {
          resolve(service.get('notificationSerializer').normalizeNotifications(response));
        }, reject);
    });
  }
});
