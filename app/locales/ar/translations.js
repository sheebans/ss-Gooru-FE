...
export default Object.assign(quizzesTranslations, {
  ...
  ar: 'Arabic',  
   ...
   "common":{  
      ...
      "add-to-collection-success":"لقد ضفت {{contentTitle}} إلى {{collectionTitle}}. هل تريد تعديل ال {{collectionType}}؟",
      "add-to-lesson-success":"لقد ضفت {{collectionTitle}} إلى {{contentTitle}}. هل تريد تعديل ال{{collectionType}}؟",
      ...
      "bookmarked-content-success":"سيتم إضافة {{contentType}} الذي تم وضع إشارة مرجعية عليه إلى صفحة التعليم المستقل الخاصة بك",
      "bookmarked-success":"سيتم إضافة كل المحتوى الذي تم وضع إشارة مرجعية عليه إلى صفحة التعليم المستقل الخاصة بك",
      "builder":"محرِر",
      "cancel":"إلغاء",
      "categories":"فئات",
      "category":"فئة",
      ...
      "delete-instructions":{  
         ...
         "content-inaccessible":"سيتعذر وصول محتوى المساق المحذوف إلى الصفوف الدراسية المرتبطة به."
      },
      ...
      "errors":{  
         ...
         "can-not-join-class":"تعذر الانضمام إلى الصف الدراسي، يرجى إعادة المحاولة بعد قليل",
         "assessment-not-added-to":"تعذر إضافة التقييم للدرس في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         "assessment-not-copied":"تعذر نسخ التقييم الآن. يرجى إعادة المحاولة بعد قليل",
         "assessment-not-created":"تعذر إنشاء التقييم الآن. يرجى إعادة المحاولة بعد قليل",
         "assessment-not-updated":"تعذر تحديث التقييم الآن. يرجى إعادة المحاولة بعد قليل",
         "category-title-presence":"يرجى إدخال عنوان الفئة",
         "class-min-score":"يجب أن يكون الحد الأدنى للعلامة بين 1 و 100",
         "class-not-created":"تعذر إنشاء الصف الدراسي الآن. يرجى إعادة المحاولة بعد قليل",
         "class-title-presence":"يرجى تسمية صفك الدراسي",
         "collection-not-added-to":"يتعذر إضافة المجموعة إلى الدرس في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         "collection-not-copied":"تعذر نسخ المجموعة في الوقت الحالي، يرجى إعادة المحاولة بعد قليل",
         "collection-not-created":"تعذر إنشاء المجموعة في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         "collection-not-updated":"تعذر تحديث المجموعة الآن. يرجى إعادة المحاولة بعد قليل",
         "collection-title-presence":"يرجى إدخال عنوان المجموعة",
         "correct-answer-presence":"يرجى تحديد الإجابة الصحيحة",
         "course-not-copied":"تعذر نسخ المساق الدراسي في الوقت الحالي، يرجى إعادة المحاولة بعد قليل",
         "course-not-created":"تعذر إنشاء المساق الدراسي في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         "course-not-updated":"تعذر تحديث المساق الدراسي في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         ...
         "file-upload-missing":"يرجى اختيار ملف بأي من الامتدادت التالية: {{extensiones}}",
         "getting-next-resource":"حدث خطأ في تثبيت الإجابات، يرجى المحاولة مرة أخرى.",
         "lesson-not-copied":"تعذر نسخ الدرس في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         "lesson-not-created":"تعذر إنشاء الدرس في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         "lesson-not-loaded":"تعذر تحميل الدرس في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         ...
         "profile-not-updated":"تعذر تحديث الملف الشخصي في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         "question-not-added-to":"تعذر إضافة سؤال إلى {{collectionType}} في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         "question-not-copied":"تعذر نسخ السؤال في الوقت الحالي. يرجى  إعادة المحاولة بعد قليل",
         "question-not-created":"تعذر إنشاء سؤال في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         "question-not-updated":"تعذر تحديث السؤال في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         "reset-password-error":"هناك خطأ ما، لا يمكن إعادة تعيين كلمة المرور. يرجى المحاولة بعد قليل",
         "reset-google-account-exists":"لقد تم إنشاء حسابك باستخدام حساب جوجل، ولا يمكننا إعادة تعيين كلمة المرور الخاصة به. إذا نسيت كلمة المرور الخاصة بحساب جوجل، يجب عليك إعادة تعيينها عن طريق تطبيقات جوجل.",
         "resource-description-length":"الحد الأقصى لعدد الأحرف في الوصف هو 500 حرف.",
         ...
         "resource-not-added-to-collection":"تعذر إضافة المصدر إلى المجموعة في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         "resource-not-copied":"تعذر نسخ المصدر في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         "resource-not-created":" تعذر إنشاء المصدر في الوقت الحالي. الرجاء إعادة المحاولة بعد قليل",
         "resource-not-updated":"تعذر تحديث المصدر في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         "resource-same-host-url":"لا يمكن أن تكون المصادر عبارة عن روابط خاصة بجورو",
         ...
         "sign-in-credentials-not-valid":"هناك خطأ ما، يرجة التأكد من اسم المستخدم وكلمة المرور والمحاولة مرة أخرى",
         "sign-in-google-account-exists":"يرجى تسجيل الدخول باستخدام جوجل، لا يمكننا إعادة تعيين كلمة المرور",
         ...
         "unit-not-copied":"تعذر نسخ الوحدة في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         "unit-not-created":"تعذر إنشاء الوحدة في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         "unit-not-loaded":"تعذر تحميل الوحدة في الوقت الحالي. يرجى إعادة المحاولة بعد قليل",
         ...
         "forgot-password-gmail":"يرجى تسجيل الدخول باستخدام جوجل، لا يمكننا إعادة تعيين كلمة المرور"
      },
      ...
      "link":"الربط",
      "link-out":"ربط خارجي",
      "link-out-message":"* إذا ظهر المصدر الخاص بك فارغاً عند المعاينة أعلاه، فقد تحتاج إلى تفعيل خاصية \"ربط خارجي\" لعرض المحتوى في صفحة أخرى.",
      ...
      "no-content-my-report":"لا يوجد تقارير، سيكون لديك تقارير عند البدء بالتعلم.",
      ...
      "no-independent-results":"عندما تبدأ البحث عن  {{contentType}} يحتوي على إشارة مرجعية، سيظهر هنا.",
      "no-results":"لم يتمّ العثور على نتائج.",
      "no-available-results":"لا يوجد نتائج",
      "no-results-message":"يرجى تفقد الإملاء، هناك خطأ ما.\nابحث في نطاق أوسع واحذف بعض مرشحات البحث.\nأو ابحث عن كلمة مشابهة.",
      "no-more-attempts":"لا مزيد من المحاولات",
      "no-dca-student":"لم يقم معلمك بتعيين أي مجموعات أو تقييمات إلى نشاطات الصف اليومية.",
      "no-dca-teacher":"لا يوجد نشاطات حالية. ضِف نشاطات الصف اليومية من \"خريطة المساق الدراسي\" أو من \"المحتوى الخاص بي\"",
      ...
      "remix-assessment-success":"تمت إعادة مزج التقييم {{assessmentTitle}}. هل تريد تعديل هذا التقييم؟",
      "remix-collection":"إعادة مزج المجموعة.",
      "remix-collection-lead":"أنت على وشك إعادة مزج المجموعة.",
      "remix-collection-success":"لقد قمت بإعادة مزج مجموعة {{collectionTitle}}. هل تريد تعديل هذه المجموعة؟",
      "remix-course":"إعادة مزج المساق الدراسي.",
      "remix-course-lead":"أنت على وشك إعادة مزج المساق الدراسي.",
      "remix-course-success":"لقد قمت بإعادة مزج المساق الدراسي {{courseTitle}}. هل تريد تعديل هذا المساق؟",
      ...
      "remix-question-success":"لقد قمت بإعادة مزج سؤال {{questionTitle}}. هل تريد تعديل هذا السؤال؟",
      "remix-resource":"إعادة مزج المصدر",
      "remix-resource-lead":"أنت على وشك إعادة مزج المصدر.",
      "remix-resource-success":"لقد قمت بإعادة مزج مصدر {{resourceTitle}}. هل تريد تعديل هذا المصدر؟",
      ...
      "remix-warning":"هناك الكثير من المحتوى الرائع في هذا المساق، ونسخه سيستغرق وقتاً، يرجى تأكيد بدء عملية النسخ وفي غضون 15 دقيقة ستكون نسختك على ملفك الشخصي. ",
      "remove":"حذف",
      "report":"تقرير",
      ...
      "score":"العلامة",
      "select":"اختر",
      "select-a-framework":"يرجى أولا اختيار إطار المعايير في قسم معلومات المساق الدراسي أعلاه.",
      "sentence":"جملة",
      "settings":"إعدادات",
      "search":"بحث",
      ...
      "studen-id-display":"هوية الطالب (غير ظاهرة على الملف الشخصي ولكن ظاهرة عند التقييم المجهول)",
      ...
      "warnings":{  
         "on-air-connection-lost":"فقدت لوحة تحكم \"التقييم المباشر\" الاتصال، وتتم إعادة المحاولة تلقائيا. يرجى عدم تحديث الشاشة.",
   ...
   "index":{  
      ...
      "gettingStarted":{  
         ...
         "toolkit":{  
            ...
            "description":"مرحبا بكم في جورو! ألق نظرة على هذه المصادر لمعرفة ما يمكنك القيام به مع جورو والبدء بسرعة."
         },
         "classroom":{  
            "title":"قصص من الصف الدراسي",
            "description":"تعلم مقتدياً بالقصص المطروحة من قبل المعلمين الذين يقولون أن جورو قد أحدث فرقاً في صفوفهم الدراسية."
         },
         "events":{  
            "title":"أهم الأحداث.",
            "description":"نقدم ندوات ودورات تدريبية مجانية لمساعدتك في البدء مع جورو."
         }
      },
      "empowerStudents":{  
      ...
      "findDescription":"تصفح الآلاف من المجموعات من الروضة وحتى الصف 12 التي أعدّها المعلمون  أو ابحث فيما يزيد عن 16 مليون مصدر. ",
      "remixDescription":"أعد مزج المجموعات ونسق المحتوى لتلبية احتياجات طلابك.",
      "shareDescription":"شارك المجموعات مع طلابك من خلال صفوف جورو. تسجيل الدخول غير مطلوب.",
      "monitorDescription":"قم بقياس مدى تقدم وتفاعل الطلاب، للتدخل المباشر إذا تطلب الأمر ذلك.",
      "freeAndOpen":{  
         "title":"مجاني ومتوفر دائماً",
         "description":"نؤمن بان التعليم حق من حقوق الإنسان. سيقدم موقع جورو للمعلمين والطلاب في جميع انحاء العالم خدمات تعليم مجانية دائمة وبدون إعلانات. ",
   ...
   "class":{  
      ...
      "edit":{  
         ...
         "class-greetings-placeholder":"ألقِ التحية على طلابك أو حفزهم أو أنشئ إعلاناً لهم...إلخ",
      ...
      "analytics":{  
         "performance":{  
            "title":"عرض الأداء",
            "better-experience-message":"للحصول على تجربة أفضل مع جورو، قم بعرض التحليل الخاص بالصف الدراسي على الحاسوب المكتبي أو الحاسوب اللوحي.",
   ...
   "content":{  
      ...
      "classes":{  
         ...
         "join":{  
            ...
            "class-not-found":"لم يتم العثور على الصف الدراسي. تأكد من إدخال رمز الصف الدراسي الصحيح.",
            "invalid-code":"رمز الصف الدراسي غير صالح.",
            "already-member":"أنت عضو في هذا الصف  الدراسي بالفعل.",
            "join-class":"انضم للصف الدراسي",
            "terms-and-conditions":"من خلال النقر على الانضمام إلى الصف الدراسي، أوافق على مشاركة بيانات تقدُّم تقييمي ومجموعتي التي تم إنشاؤها من خلال الدراسة في هذا الصف الدراسي ومعلميه في جورو."
         }
      },
      "collections":{  
         "edit":{  
            "assign-to-course":"تعيين إلى المساق الدراسي",
            "best-practices":"يستطيع الطلاب التفاعل مع المحتوى في مرحلة \"المجموعة\" ، فعند إنشاء مجموعة تعليمية تأكد من احتوائها على أهداف التعلم، مع الأخذ بعين الاعتبار استخدام أنواع متعددة من المصادر لعرض المفاهيم للطلاب وبطرق متعددة.\nاستخدم المصادر بشكل متسلسل لبناء المفاهيم، التقدم في مرحلة \" المجموعة\" يجب أن يتمّ بشكل منطقي، ويجب أن ينقل الطلاب المستهدفين من مرحلة عامة إلى مرحلة أكثر تعقيداً من الاستيعاب إذا كان ذلك مناسباً، أو أن يسمح باكتشاف مستوى الطلاب بشكل كافٍ.\n\nيمكنك أيضا للتحقق من مدى استيعاب الطلاب من خلال أسئلة جورو أو الوسائل التفاعلية الأخرى. نوصي بما يكفي من المصادر و/ أو تنوّع كاف من المصادر لتحقيق أهداف المجموعة والتأكد من أن كل مصدر له دور وهدف معين."
         }
      },
      "courses":{  
         "edit":{  
            "assign-to-class":"تعيين إلى الصف",
            "best-practices":"المساق الدراسي هو ملف يسمح لك بتنظيم المحتوى التعليمي الخاص بك على شكل وحدات ودروس. عند إنشاء مساق دراسي يجب أن تأخذ بعين الاعتبار الأسئلة الأساسية وأهداف التعلم وتنظيم المحتوى الخاص بك.\n\nتستطيع  تجميع الدروس معاً لإنشاء تجربة مختلفة لطلابك (مثال: يمكنك ترتيب الوحدات حسب التسلسل الزمني أو الموضوع أو المعيار)",
            "information":{  
               "course-title":"عنوان المساق الدراسي",
               "description":"وصف"
            }
         ...
         "edit":{  
            ...
            "builder":{  
               ...
               "answer-instructions":{  
                  ...
                  "HS_IMG":"يمكنك إضافة ما يصل إلى 10 إجابات على شكل صورة واختيار إجابة صحيحة واحدة أو أكثر.",
                  "HS_TXT":"يمكنك إضافة ما يصل إلى 10 إجابات على شكل خيارات واختيار إجابة صحيحة واحدة أو أكثر.",
                  "HT_HL_ST":"عند كتابة السؤال، استخدم الأقواس للإشارة إلى الجمل المظللة. بحيث يحتوي زوج الأقواس الواحد على جملة واحدة فقط تنتهي بنقطة. مثال: بنى الخنزير الأول الصغير منزله من القش. (هاجم الذئب السيء الكبير المنزل من الأسفل.) بنى الخنزير الثاني بيته من الخشب. الحد الأقصى للأحرف: 5000",
                  "HT_HL_WD":"عند كتابة السؤال، استخدم الأقواس للإشارة إلى الكلمات المظللة. بحيث يحتوي زوج الأقواس الواحد على كلمة واحدة فقط. مثال: هاجم الذئب الشرير (الكبير) المنزل من (الأسفل). الحد الأقصى للأحرف: 5000",
                  "HT_RO":"يمكنك إضافة ما يصل إلى 10 إجابات بالترتيب الصحيح. حيث أن الترتيب سيكون عشوائيا لدى الطلاب.",
                  "MA":"يمكنك إضافة ما يصل إلى 10 إجابات وصورة وشرح وما يصل إلى 5 تلميحات.",
                  "MC":"يمكنك إضافة ما يصل إلى 10 إجابات وتحديد إجابة صحيحة واحدة. الحد الأقصى للأحرف: 200 ",
                  "OE":"اكتب الإجابة الصحيحة. الحد الأقصى للأحرف: 5000.",
                  "T/F":"اختر الإجابة الصحيحة."
               },
               "question-instructions":{  
                  "FIB":"عند كتابة السؤال بصيغة \"املأ الفراغ\"، استخدم الأقواس لتحديد الكلمات التي يجب أن يكون مكانها فارغاً في الجملة. مثال: \"هاجم (الذئب) الشرير الكبير (المنزل) من الأسفل.\" يمكنك إضافة صورة أيضاً.",
                  "HS_TXT":"اكتب سؤالك.",
                  "HS_IMG":"اكتب سؤالك.",
                  "HT_RO":"اكتب سؤالك.",
      ...
      "modals":{  
         "delete-bookmark":{  
            ...
            "delete-error":"تعذر حذف الإشارة المرجعية عن هذا الـ {{type}} الآن. يرجى إعادة المحاولة بعد قليل."
         },
         "remove-class-activity":{  
            "confirmation":"هل أنت متأكد من حذف هذا {{type}} من قائمة نشاطات الصف اليومية؟ ",
         ...
         "archive-class":{  
            ...
            "not-add-students":"لن تتمكن من إضافة المزيد من الطلاب إلى الصف الدراسي",
         ...
         "delete-content":{  
            ...
            "delete-error":"تعذر حذف {{type}} في الوقت الحالي. يرجى إعادة المحاولة بعد قليل.",
            "confirmation":"هل تريد المتابعة؟ يرجى كتابة \"حذف\" أدناه وانقر على \"حذف\"."
         },
         "delete-resource":{  
            ...
            "second-check":"سيتم حذف جميع نسخ هذا المصدر في مجموعاتك ومجموعات أي مستخدم في منظمتك."
         },
         "delete-rubric":{  
            "legend":"يرجى تأكيد حذف {{title}} بشكل نهائي.",
         ...
         "remove-content":{  
            ...
            "remove-error":"يتعذر حذف {{type}} في الوقت الحالي. يرجى إعادة المحاولة بعد قليل.",
            "confirmation":"هل تريد المتابعة؟ يرجى كتابة \"حذف\" أدناه والنقر على \"حذف\"."
         },
         "remove-student":{  
            "title":"حذف الطالب وبياناته",
            "legend":"أنت على وشك حذف{{studentName}} من هذا الفصل الدراسي وحذف جميع بياناته.",
            "data-inaccessible":"سيتم حذف جميع البيانات الخاصة به  ولا يمكن الوصول إليها من قبل أيٍ منكم.",
            "classroom-access":"لن يتمكن من الوصول إلى الصفوف الدراسية أو المحتوى.",
            "data-lost":"في حال انضمامه مرة أخرى، سيفقد جميع البيانات السابقة.",
            "remove-error":"تعذر حذف هذا الطالب في الوقت الحالي. يرجى إعادة المحاولة بعد قليل.",
            "confirmation":"هل تريد المتابعة؟ يرجى كتابة \"حذف\" أدناه وانقر على \"حذف\"."
         },
   ...
   "student-landing":{  
      ...
      "my-performance":{  
         ...
         "collections":"مجموعات",
         "filter":"مُرشِح",
         "primary-text":"قم باختيار الأشياء التي تريد تحليلها، وسنقوم بإنشاء تقرير خاص بالأداء.",
         "subject":"موضوع",
         "title":"حلل أدائك",
      ...
      "my-study":"دراستي",
      "no-classrooms":"لم تنضم إلى أي صف دراسي بعد . انقر على \"انضم للصف\" لإضافة الصف الخاص بمعلمك. بإمكانك أن تبحث عن الصفوف الدراسية المميزة تحت علامة تبويب \"المكتبة\".",
   ...
   "student-independent-learning":{  
      ...
      "no-courses":"ستظهر لك المساقات الدراسية التي تم وضع إشارات مرجعية عليها عندما تبحث عنها هنا. ",
      "no-collections":"ستظهر لك المجموعات التي تم وضع إشارات مرجعية عليها عندما تبحث عنها هنا. ",
      "no-assessments":"ستظهر لك التقييمات التي تم وضع إشارات مرجعية عليها عندما تبحث عنها هنا. ",
      "no-independent-results":"ابحث عن \"المكتبة\" لتعلم أشياء جديدة.",
      "no-bookmarks":"ستظهر المساقات الدراسية والمجموعات والتقييمات عندما يتم وضع إشارات مرجعية عليها هنا. ",
   ...
   "teacher-landing":{  
      ...
      "class":{  
         ...
         "class-management-tab":{  
            ...
            "students-null":"شارك رمز الصف مع الطلاب ليتمكنوا من الانضمام لصفك الدراسي."
         },
         "class-activities":"أنشطة الصف اليومية",
         ...
         "class-activities-tab":{  
            ...
            "welcome-dca":"أهلاً بك في نشاطات صفك اليومية، هنا يمكنك تعيين مجموعات وتقييمات لطلابك لإكمالها اليوم. \nملاحظة: أي تقارير يتم إنشاءها ستكون متوفرة اليوم حتى آخر محاولة. "
         },
      ...
      "no-classrooms":"لم تنشئ صفوف دراسية بعد، اضغط على \"أنشئ صف دراسي\"، أو ابحث عن المساقات الدراسية المميزة تحت علامة التبويب \"المكتبة \" ",
      "no-course":"لم تُعيِّن مساق دراسي لهذا الصف بعد.",
      "teach":"درِّس في صفوف جورو الدراسية.",
      "welcome-course-map":"في خريطة المساق الدراسي، يمكنك عرض محتوى المساق، وتشغيل التقيماات أو إيقافها، و إطلاق التقييمات في الوقت الحالي. كما يمكنك مشاهدة "
   },
   "goals":{  
      "manage":{  
         "title":"أهدافي!",
         ...
         "save":"حفظ",
         "update":"تحديث",
         "goals-not-found":"لم تحدد أي أهداف بعد. يمكنك إضافة هدف بالنقر على \\\"Add Goal\\\" أعلاه. "
      },
      "create":{  
         ...
         "error-greater-end-date":"يجب أن يكون تاريخ الانتهاء أحدث من تاريخ البدء",
         "error-add-status":"يرجى تحديد حالة الهدف",
         "error-length-reflection":"الحد الأقصى من الأحرف لكتابة مدى تأثير الهدف 2000 حرف",
   ...
   "gru-add-to":{  
      ...
      "assessments-info":"التقييمات المدرجة هنا لا تنتمي إلى درس أو مساق دراسي آخر.",
      "collections-info":"المجموعات المدرجة هنا لا تنتمي إلى درس أو مساق دراسي آخر. "
   },
   "gru-add-rubric-to-question":{  
      "title":"ضِف من سلم التقييم الخاص بي",
      "lead":"اختر سلم تقييم لإضافته لهذا السؤال",
      "no-rubrics":"لم تنشئ أي سلم تقييم لإرفاقه مع سؤال \"الإجابة الكتابية\". يمكنك إنشاء سلم تقييم تحت علامة تبويب \"المحتوى الخاص بي\" التي يمكن الولوج إليها من خلال ملفك الشخصي. ",
   ...
   "gru-assessment-confirmation":{  
      ...
      "setting-forward-backward":"يمكنك التنقل إلى الأمام وإلى الخلف للإجابة على الأسئلة.",
   ...
   "gru-submit-confirmation":{  
      ...
      "description":"أنت على وشك إنهاء هذا الاختبار وإرسال جميع الأجوبة. أي سؤال لم تتم الإجابة عليه يعتبر جواباً خاطئاً. ",
      "cancel":"إلغاء",
   ...
   "gru-category-panel":{  
      "teacher":{  
         "title":"للمعلمين",
         "body":"اكتشف المحتوى المتوافق مع المعايير ونسق المحتوى وتتبع تقدم الطلاب من خلال تحليلات البيانات.",
         "cta":"شاهد القصص"
      },
      "student":{  
         "title":"للطلاب",
      ...
      "district":{  
         "title":"للمقاطعات",
         "body":"تعاون  مع جورو لإطلاق العنان للتعليم المخصص ولمشاركة المنهاج الذي تمت مراجعته من قبل السلطات المعنية.",
         "cta":"شاهد مدى تأثيرنا"
      },
      "partner":{  
         "title":"للشركاء",
         "body":"تعاون مع شركائنا في المهمة لرفع نسبة التأثير الجماعي على بيئة التعليم. ",
         "cta":"تعلم المزيد"
      }
   },
   ...
   "gru-user-registration":{  
      ...
      "joinDescription":"جِد وامزج، وشارك أفضل مصادر التعليم المجانية من الروضة وحتى الصف 12. ",
      "googleButton":"أنشئ حسابك باستخدام جوجل.",
      "whyGoogle":"لماذا أنشئ حساباً باستخدام جوجل؟",
      "descriptionWhyGoogle":"إنشاء حسابك باستخدام جوجل سيكون أسهل وأسرع ولن تحتاج إلى كلمة مرور جديدة. ",
      "or":"أو",
   ...
   "gru-welcome-message":{  
      ...
      "text-temporary-one":"يسعدنا مساعدتك خلال رحلتك في متصفح جورو التعليمي، ابحث عن أيقونة  \"قم بجولة\" ",
      "text-temporary-two":"للجولات الإرشادية حول كيفية استخدام مميزاتنا. ",
      "text-one":"يسعدنا مساعدتك خلال رحلتك في متصفح جورو التعليمي بالطرق التالية: ",
      "text-two":{  
         "subtitle":"قم بجولة",
   ...
   "sign-up":{  
      ...
      "error-email-taken":"هذا البريد الإلكتروني مُستخدم، يرجى المحاولة مرة أخ\nرى",
      ...
      "error-district-message":"يرجى اختيار المقاطعة من القائمة أو قم بتزويدنا بها في \"أخرى\" "
   },
   ...
   "forgot-password":{  
      ...
      "footer-google-description-1":"حاول تسجيل الدخول مرة أخرى بالضغط على \\\u0027تسجيل الدخول باستخدام جوجل\\\u0027",
      "footer-description-1":"ستصلك رسالة إلكترونية تتضمن رابطاً لإعادة تعيين كلمة المرور.",
      ...
      "secondStepDescription-1":"لقد أرسلنا لك رسالة إلكترونية تتضمن رابطاً لإعادة تعيين كلمة المرور. ",
   ...
   "footer":{  
      "footerDescription":"يلتزم موقع جورو بالإبقاء على منصته التعليمية مفتوحة المصادر، وإتاحتها لبناء محتوى يحمل رخصة المشاع الإبداعي(CC0) ",
      "company":"الشركة",
      "community":"المجتمع",
      "legal":"قانوني",
      "connect":"الاتصال",
   ...
   "gru-image-picker":{  
      ...
      "restriction":"يجب أن تكون الصورة بصيغة  JPG أو GIF أو PNG وحجمها أقل من 5 ميغابايت.",
      "submit":"استخدم الصورة"
   },
   "gru-fib":{  
      "instructions":"يرجى كتابة إجابتك في الفراغ المناسب، ثم الضغط على \\\"{{action}}\\\"."
   },
   "gru-hs-image":{  
   ...
   "gru-open-ended":{  
      "instructions":"يرجى كتابة إجابتك في الحقل أدناه، ثم الضغط على \\\"{{action}}\\\". لحفظها عند الانتهاء.",
   ...
   "gru-reorder":{  
      "instructions":"يرجى إعادة ترتيب الإجابات بشكل صحيح، ثم النقر على \\\"{{action}}\\\"."
   },
   "player":{  
      "gru-navigation":{  
         "view-report":"عرض التقرير"
      ...
      "gru-viewer":{  
         "not-iframe-url":{  
            ...
            "footer_3":"ينشؤون ويشاركون المحتوى الخاص بهم. تحتوي المصادر على إعدادت مختلفة تتضمن",
   ...
   "cards":{  
      "gru-class-card":{  
         ...
         "archived":{  
            "request-report":"لا يمكن تعديل هذا الصف الدراسي لأنه مؤرشف، ويمكن الوصول إلى بيانات الصف الدراسي الحالي من خلال التقرير.",
            "report-in-progress":"قد يستغرق إنشاء التقرير 20 دقيقة. يرجى التحقق مرة أخرى.",
   ...
   "home":{  
      "no-classes-found":{  
         ...
         "featured-courses":{  
            ...
            "description":"تصفح مساقات الرياضيات والعلوم والدراسات الاجتماعية ومهارات اللغة الإنجليزية.",
   ...
   "featured":{  
      ...
      "featured-description":"يتم تنظيم المساقات الدراسية المميزة من قبل معلمين مبتكِرين، وفحصها ومراجعتها من قِبل خبراء في المحتوى التعليمي. كما يتم تطبيقها في الصفوف الدراسية مع الطلاب. \nاكتشف وامزج ونسّق المساقات التعليمية لتخصيص التعليم ورفع مستوى تفاعل الطلاب مع هذه المساقات. اضغط هنا لمعرفة المزيد عن تطوير هذه المساقات."
   },
   "taxonomy.modals":{  
      "gru-domain-picker":{  
   ...
   "gru-settings-edit":{  
      ...
      "disable-legend":"يمكن للطلاب تشغيل التقييم من خريطة المساق الدراسي الخاصة بهم"
   },
   "gru-icon-popover":{  
      "settings-visibility-title":"اجعل المحتوى الخاص بك مرئياً",
      "settings-visibility-content":"هذا يجعل المحتوى الخاص بك مرئياً في ملفك الشخصي. إذا كنت ترغب في مشاركة المساقات والمجموعات والتقييمات والمصادر و/ أو الأسئلة التي تنشئها مع الزملاء، نقترح عليك تفعيل هذه الميزة."
   },
   "gru-take-tour":{  
      "text":"جولة",
      "teacher-home":{  
         ...
         "stepSeven":{  
            "title":"ملفك الشخصي",
            "description":"يمكنك ولوج وتحديث المحتوى الخاص بك وملفك الشخصي والإعدادات."
         },
         "stepEight":{  
            "title":"المساعدة",
         ...
         "stepEleven":{  
            ...
            "description":"قم بتسمية صفك الدراسي واضغط على الزر لإنشاء صف دراسي جديد. "
         }
      },
      "student-home":{  
         "stepOne":{  
            "title":"قم بجولة",
            "description":"أهلا بك في \"قم بجولة\" وفي صفحتك الرئيسية، لنشاهد الميزات المتوفرة لك في صفحتك الرئيسية. "
         },
         "stepFeaturedCourses":{  
            "title":"المساقات الدراسية المميزة",
            "description":"تصفح المساقات الدراسية المميزة في المواضيع التي تهمك في فهرس المحتوى الخاص بمتصفح التعليم."
         },
         "stepTwo":{  
            "title":"شِعار",
            "description":"ستعود إلى صفحتك الرئيسية بالنقر على الشِعار. "
         ...
         "stepFive":{  
            "title":"المكتبة",
            "description":"تصفح المساقات الدراسية المميزة في متصفح التعليم وفي مكتبات الشركاء لإيجاد عدد من المواضيع التي تهمك."
         },
         "stepSix":{  
            "title":"أداء",
         ...
         "stepNine":{  
            "title":"الإعلانات",
            "description":"هنا سترى الإعلانات التي يرغب معلمك أو المدرسة أن تعرف عنها."
         },
         "stepTen":{  
            "title":"الصفوف الدراسية",
         ...
         "stepEleven":{  
            ...
            "description":"ابحث عن المواضيع التي وضعت عليها إشارة مرجعية والتي تريد أن تتعلمها. "
         },
         "stepTwelve":{  
         ...
         "stepThirteen":{  
            "title":"انتهيت!",
            "description":"والآن اضغط على مساق دراسي سجلت به، انضم للصف الدراسي، أو ابحث عن المحتوى الذي يهمك. "
         }
      },
      "student-performance":{  
         "stepOne":{  
            "title":"أهلا بك!",
            "description":"مرحبا بكم في لوحة الأداء الخاصة بك. يمكنك استعراض أدائك في جميع الصفوف والمساقات الدراسية."
         },
         "stepTwo":{  
            "title":"علامة تبويب تفصيل البيانات",
            "description":"انقر على السهم لتفصيل البيانات الخاصة بأدائك حسب النشاط والفترة الزمنية والموضوع والمساق الدراسي."
         },
         "stepThree":{  
            "title":"تحديث التقرير",
            "description":"بعد تحديد المرشِّحات، انقر على \"تحديث التقرير\" لعرض النتائج."
         },
         "stepFour":{  
      ...
      "student-class":{  
         "stepOne":{  
            "title":"أهلا بك!",
            "description":"أهلا بك في صفك الدراسي، هنا ستجد نشاطات صفك اليومية وخريطة المساق الدراسي وبيانات الأداء. لنبدأ الآن"
         },
         "stepTopBar":{  
         ...
         "stepThree":{  
            "title":"خريطة المساق الدراسي",
            "description":"انقر على الوحدات والدروس لإكمال المجموعات والتقييمات في المساق الدراسي."
         },
         "stepFour":{  
            "title":"تقريري",
         ...
         "stepFive":{  
            "title":"انتهيت!",
            "description":"ابدأ بدراة المساق الدراسي بالنقر على \"خريطة المساق الدراسي\" أو \"النشاطات اليومية\""
         }
      },
      "teacher-class":{  
         "stepOne":{  
            "title":"أهلا بك!",
            "description":"أهلاً بك في صفك الدراسي، هنك يمكنك مشاهدة وتعيين نشاطات صفك اليومية وخريطة المساق وتحديث معلومات الصف ومشاهدة بيانات أداء الطلاب. لنبدأ الآن!"
         },
         "stepTopBar":{  
            "title":"المساق الدراسي، الأداء، الإكمال",
            "description":"شاهد ملخص عن المساق الدراسي والأداء العام حتى الآن. "
         ...
         "stepThree":{  
            "title":"خريطة المساق الدراسي",
            "description":"شاهد و عدِّل الوحدات و الدروس والمجموعات و التقييمات المُعيَّنة في هذا المساق."
         },
         "stepFour":{  
            "title":"تقريري",
            "description":"يمكنك مشاهدة ملخص عن آداء طلابك في المساق وولوج تقاريرهم. "
         },
         "stepClassManagement":{  
      ...
      "study-player":{  
         "stepOne":{  
            "title":"أهلا بك!",
            "description":"هذا هو مشغل الدراسة الخاص بك، لنلق نظرة على الميزات المتوفرة لك. "
         },
         "stepTwo":{  
            "title":"خريطة المساق الدراسي",
         ...
         "stepFour":{  
            "title":"اقتراحات",
            "description":"المصادر الإضافية التي من الممكن أن ترغب بالبحث عنها بناءً على ما تدرسه"
         },
         "stepFive":{  
            "title":"إنجاز",
            "nuTitle":"كفاءات",
         ...
         "stepNine":{  
            ...
            "description":"انقر على الأيقونة في أي وقت للعودة إلى المجموعة أو التقييم."
         }
      },
      "library":{  
         "stepOne":{  
         ...
         "stepTwo":{  
            "title":"المساقات الدراسية المميزة",
            "description":"ابحث في المساقات الدراسية التي طورها وطبقعا المعلمون سابقاً في صفوفهم الدراسية."
         },
         "stepThree":{  
            "title":"مكتبات أخرى",
      ...
      "profile":{  
         "stepOne":{  
            "title":"أهلا بك!",
            "description":"أهلاً بك في ملفك الشخصي، هنا يمكنك الولوج للمحتوى الخاص بك ومعلوماتك الشخصية و المتابعين."
         },
         "stepTwo":{  
         ...
         "stepThree":{  
            "title":"حولي",
            "description":"حدِّث معلوماتك الشخصية ومعلومات المدرسة و الصورة الشخصية. "
         },
         "stepFour":{  
            "title":"الأهداف",
            "description":"ضَع و تعقب الأهداف لمساعدتك في تحقيق أهداف التعلم الخاصة بك. "
         },
         "stepFive":{  
            "title":"متابِعون",
            "description":"إذا أعجبك محتوى إحدى المساقات الدراسية، يمكنك متابعة الأشخاص الذين قاموا ببنائه. كما يمكنك مشاهدة المتابعين. "
         },
         "stepSix":{  
            "title":"شارات",
            "description":"شاهد الشارات التي حصلت عليها، ستحصل على شارة في حال إكمال تقييم معياري تم تعيينه من قِبل معلمك."
         }
      }
   },
   "gru-tour":{  
      "assessments-settings":{  
         "stepOne":{  
            ...
            "description":"يحدد هذا الإعداد كيفية انتقال الطلاب خلال تقييم معيّن ويبين ما إذا كانت إجاباتهم صحيحة أم خاطئة. هذا الإعداد لا يُظهر لهم مفتاح الإجابة."
         },
         "stepTwo":{  
            "title":"مفتاح الإجابة  وعدد المحاولات.",
            "description":"يتيح هذا الإعداد إظهار مفتاح الإجابة  ويحدد عدد المحاولات التي يملكها الطلاب في التقييم."
         }
      },
      "overview":{  
         "stepOne":{  
            "title":"خريطة المساق الدراسي",
            "description":"تتيح خريطة المساق الدراسي للطلاب الوصول إلى جميع التقييمات والمجموعات التي تعيّنها لهم."
         },
         "stepTwo":{  
            "title":"رمز الصف",
            "description":"لكل صف تقوم بإنشائه رمز خاص. ستعطي هذا الرمز للطلاب عندما يصبح صفك الدراسي جاهز لانضمامهم ووصولهم إلى المحتوى الخاص بك."
         },
         "stepThree":{  
            "title":"مراقبة بيانات الطالب والصف.",
            "description":"تتيح لك هذه الخطوة رؤية بيانات تقييم الصف والطالب عند استكمال الطلاب للتقييمات التي تشكّل جزءاً من المساق الدراسي."
         },
         "stepFour":{  
            "title":"معلومات الصف االدراسي",
            "description":"هنا يمكنك تعديل اسم صفك الدراسي، ونشر الإعلانات لطلابك، ورؤية أسماء الطلاب المسجلين فيه، وحذفه."
         },
         "stepFive":{  
            "title":"تعديل محتوى المساق الدراسي.",
            "description":"عندما تكون في صف دراسي، انقر هنا لتعديل أي محتوى في المساق الدراسي المعيّن لطلابك."
         },
         "stepSix":{  
            "title":"رصد التقدم المحرز في الوقت الحقيقي!",
            "description":"استخدم لوحة تحكم \"الوقت الحقيقي\" لرصد تقدم الصف المحرز على التقييم في نفس وقت عمله.\nانقر على أيقونة \u0027التقييم المباشر\u0027 -الموجودة إلى يسار كل تقييم- لبدء تقييم الطلاب في نفس وقت عملهم"
         }
      },
      "quick-start":{  
         "stepOne":{  
            "title":"التنقل بين الصفوف الدراسية",
            "description":"هذا هو شكل الصف الدراسي الذي تم إنشاؤه حديثا. للرجوع إلى الصف الدراسي في أي وقت، انقر على \u0027الصفوف الدراسية\u0027 واستخدم القائمة المنسدلة لتحديد الصفوف الدراسية التي ترغب في دخولها."
         },
         "stepTwo":{  
            "title":"البدء؟ أنشئ تقييم!",
            "description":"نقترح عليك إنشاء تقييم كوسيلة للبدء مع جورو وتقييم مستوى فهم الطلاب الحالي في صفك."
         }
      },
      "real-time":{  
         "stepOne":{  
         ...
         "stepTwo":{  
            ...
            "description":"اختر خانة كلّ طالب للاطلاع على تقارير بيانات الطالب الفردية."
         },
         "stepThree":{  
            "title":"حدد طريقة عرض",
            "description":"اختر\u0027عرض العنوان\u0027 أو \u0027عرض القائمة\u0027 للاطلاع على خيارات عرض البيانات."
         },
         "stepFour":{  
            "title":"متوسط العلامات",
            "description":"اطلع على متوسط ​​معدل الصف المحسوب في الوقت الحقيقي لجميع الإجابات"
         },
         "stepFive":{  
   ...
   "gru-suggest-test":{  
      ...
      "pre-test-lead":"يفضل الخضوع لاختبار قبل البدء بالدرس لتقييم مدى استيعاب الطالب للمفهوم الذي سيتم طرحه في هذا الدرس. يساعد هذا الاختبار الطالب في التحضير لمحتوى الدرس دون التأثير على علامة الآداء. ",
      "post-test-lead":"الاختبار التالي هو اختبار بعد الانتهاء من الدرس، ويفضل الخضوع له لتقييم مدى استيعاب الطالب للمفهوم الذي تم طرحه أثناء شرح الدرس، ولن يؤثرهذا الاختبار على علامة الآداء. ",
      "backfill-lead":"بناءً على إجاباتك في الامتحان المسبق للدرس، يُنصح بمراجعة مواد إضافية قبل البدء بالدرس، فمراجعة إحدى المواد المساندة يساعد الطالب في تعلم مادة جديدة. ",
      "benchmark-lead":"أنت على استعداد لإظهار مدى استيعابك من خلال الخضوع للتقييم معياري. سيتم منحك شارة في حال إكمال هذا التقييم بنجاح، لن يؤثر هذا التقييم على علامة الآداء. ",
      "resource-lead":"بناءً على آدائك في هذا المساق، سيعزز المصدر التالي اسيعابك له. ",
      "no":"لا، شكرا",
