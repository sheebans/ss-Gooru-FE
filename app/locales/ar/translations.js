...
export default Object.assign(quizzesTranslations, {
   "errors":{
      ...
      "greaterThanOrEqualTo":"يجب أن يكون {{description}} أكبر من أو يساوي {{gte}}",
   ...
   "common":{
      ...
      "errors":{
         ...
         "collection-not-created":"وجه الفتاة! تعذر إنشاء المجموعة في الوقت الحالي. الرجاء إعادة المحاولة بعد قليل.",
         ...
         "class-not-created":"وجه الفتاة! تعذر إنشاء الفصول الدراسية الآن. الرجاء إعادة المحاولة بعد قليل.",
         "lesson-not-copied":"وجه الفتاة! تعذر نسخ الدرس في الوقت الحالي. الرجاء إعادة المحاولة بعد قليل.",
         "join-class-code":"الرجاء إدخال رمز الفصل الدراسي.",
         "correct-answer-presence":"يرجى الإشارة إلى الإجابة الصحيحة.",
         "assessment-not-copied":"وجه الفتاة! تعذر نسخ التقييم الآن. الرجاء إعادة المحاولة بعد قليل.",
         ...
         "unit-not-created":"وجه الفتاة! تعذر إنشاء الوحدة الآن. الرجاء إعادة المحاولة بعد قليل.",
         "collection-not-added-to":"وجه الفتاة! يتعذر إضافة المجموعة إلى الدرس في الوقت الحالي. الرجاء إعادة المحاولة بعد قليل.",
         "resource-not-created":"وجه الفتاة! تعذر إنشاء مورد في الوقت الحالي. الرجاء إعادة المحاولة بعد قليل.",
         "file-upload-missing":"الرجاء تحديد ملف مع أي من الإضافات التالية: {{extensions}}",
         "sign-in-google-account-exists":"الرجاء استخدام تسجيل الدخول من غوغل. لا يمكننا إعادة تعيين كلمة المرور.",
         "forgot-password-gmail":"الرجاء استخدام تسجيل الدخول من غوغل. لا يمكننا إعادة تعيين كلمة المرور.",
         "add-course-title":"الرجاء إدخال عنوان الدورة التدريبية.",
         "course-not-updated":"وجه الفتاة! تعذر تحديث الدورة التدريبية الآن. الرجاء إعادة المحاولة بعد قليل.",
         ...
         "course-not-created":"وجه الفتاة! تعذر إنشاء الدورة التدريبية الآن. الرجاء إعادة المحاولة بعد قليل.",
         "special-characters":"لا يمكنك استخدام أحرف أو مسافات خاصة.",
         "assessment-not-updated":"وجه الفتاة! تعذر تحديث التقييم الآن. الرجاء إعادة المحاولة بعد قليل.",
         ...
         "resource-not-updated":"وجه الفتاة! تعذر تحديث المورد في الوقت الحالي. الرجاء إعادة المحاولة بعد قليل.",
         "can-not-join-class":"وجه الفتاة! تعذر الانضمام إلى الفصول الدراسية. الرجاء إعادة المحاولة بعد قليل.",
         ...
         "question-not-added-to":"وجه الفتاة! تعذر إضافة سؤال إلى {{collectionType}} الآن. الرجاء إعادة المحاولة بعد قليل.",
         "reset-password-error":"أه أوه! يوجد شئ غير صحيح. يتعذر إعادة تعيين كلمة المرور. الرجاء إعادة المحاولة بعد قليل.",
         "highlight-text-not-selected":"يرجى الإشارة إلى الإجابة الصحيحة.",
         "assessment-not-created":"وجه الفتاة! تعذر إنشاء التقييم الآن. الرجاء إعادة المحاولة بعد قليل.",
         ...
         "profile-not-updated":"وجه الفتاة! تعذر تحديث الملف الشخصي الآن. الرجاء إعادة المحاولة بعد قليل.",
         "collection-not-updated":"وجه الفتاة! تعذر تحديث المجموعة الآن. الرجاء إعادة المحاولة بعد قليل.",
         "question-not-copied":"وجه الفتاة! تعذر نسخ السؤال في الوقت الحالي. الرجاء إعادة المحاولة بعد قليل.",
         "resource-not-added-to-collection":"وجه الفتاة! يتعذر إضافة مورد إلى المجموعة الآن. الرجاء إعادة المحاولة بعد قليل.",
         "sign-up-error":"وجه الفتاة! تعذر الاشتراك الآن. الرجاء إعادة المحاولة بعد قليل.",
         "sign-up-last-name":"الرجاء إدخال اسم العائلة.",
         "lesson-not-loaded":"وجه الفتاة! تعذر تحميل الدرس في الوقت الحالي. الرجاء إعادة المحاولة بعد قليل.",
         "resource-not-copied":"وجه الفتاة! تعذر نسخ المورد في الوقت الحالي. الرجاء إعادة المحاولة بعد قليل.",
         "unit-not-copied":"وجه الفتاة! تعذر نسخ الوحدة الآن. الرجاء إعادة المحاولة بعد قليل.",
         "collection-not-copied":"وجه الفتاة! تعذر نسخ المجموعة الآن. الرجاء إعادة المحاولة بعد قليل.",
         "password-confirm":"يرجى التأكد من صحة كلمة المرور الخاصة بك.",
         "course-not-copied":"وجه الفتاة! تعذر نسخ الدورة التدريبية الآن. الرجاء إعادة المحاولة بعد قليل.",
         "assessment-not-added-to":"وجه الفتاة! تعذر إضافة تقييم للدرس في الوقت الحالي. الرجاء إعادة المحاولة بعد قليل.",
         ...
         "question-not-created":"وجه الفتاة! تعذر إنشاء سؤال في الوقت الحالي. الرجاء إعادة المحاولة بعد قليل.",
         "reset-google-account-exists":"تم إنشاء تسجيل الدخول إلى البريد الإلكتروني باستخدام حساب غوغل ولا يمكننا إعادة تعيين كلمة مرور غوغل. إذا نسيت كلمة مرور غوغل، فستحتاج إلى إعادة تعيينها من خلال تطبيقات غوغل.",
         "resource-invalid-url":"URL غير صالح.",
         "username-length":"يجب أن يكون اسم المستخدم بين 4 و 16 حرفا.",
         "question-not-updated":"وجه الفتاة! تعذر تحديث السؤال في الوقت الحالي. الرجاء إعادة المحاولة بعد قليل.",
         "sign-up-first-name":"يرجى ادخال الاسم الاول.",
         "rubric-title-presence":"الرجاء إدخال عنوان العنوان.",
         "sign-in-credentials-not-valid":"أه أوه! يوجد شئ غير صحيح. يرجى التحقق مرة أخرى من اسم المستخدم وكلمة المرور وإعادة المحاولة.",
      ...
      "bookmarked-content-success":"ستتم إضافة علامة التبويب {{contentType}} هذه المرجعية إلى صفحة التعلم المستقلة.",
      "rubrics":"عناوين",
      ...
      "remix-collection-success":"لقد قمت بإعادة تعيين مجموعة {{collectionTitle}}. هل تريد تعديل هذه المجموعة؟",
      "remix-question":"ريميكس السؤال",
      "domain":"نطاق",
      "answer-key-was-hidden":"ملاحظة: قام معلمك بإخفاء مفتاح الإجابة.",
      "collectionInitial":"C",
      "no-independent-results":"عند بدء استكشاف علامة مرجعية {{contentType}}، ستظهر هنا.",
      ...
      "close":"قريب",
      "last-name":"الكنية",
      "remix-assessment-success":"لقد أعدت إجراء تقييم {{assessmentTitle}}. هل تريد تعديل هذا التقييم؟",
      "completion":"إكمال",
      "remix-question-lead":"أنت على وشك إعادة تعيين سؤال.",
      "add-from-url":"إضافة من ورل",
      "reaction":"رد فعل",
      "assessment-external":"التقييم الخارجي",
      "select-a-framework":"يرجى أولا تحديد إطار المعايير في قسم معلومات الدورة التدريبية أعلاه.",
      ...
      "add-to-lesson-success":"لقد أضفت {{collectionTitle}} إلى {{lessonTitle}}. هل تريد تعديل ذلك {{collectionType}}؟",
      "collection":"مجموعة",
      "bookmark":"المرجعية",
      ...
      "remix-resource-success":"لقد قمت بإعادة تعيين مورد {{resourceTitle}}. هل تريد تعديل هذا المورد؟",
      ...
      "remix-question-success":"لقد أعدت إنشاء سؤال {{questionTitle}}. هل تريد تعديل هذا السؤال؟",
      ...
      "collections":"مجموعات",
      "no-results-message":"تفقد تهجئتك. نحن جميعا نخطئ! <br/> اتسع نطاقا وأزل بعض الفلاتر. <br/> أو حاول البحث عن كلمة مماثلة بدلا من ذلك.",
      ...
      "add-url":"إضافة رابط",
      "link-out-message":"* إذا ظهر موردك فارغا في المعاينة أعلاه، فقد يحتاج إلى 'رابط' إلى صفحة أخرى لعرض المحتوى.",
      ...
      "categories":"الاقسام",
      "copy":"نسخ",
      "add-to-collection-success":"لقد أضفت {{كونتنتيتل}} إلى {{كولكتيونتيتل}}. هل تريد تعديل ذلك {{كولكتيونتيب}}؟",
      "explore":"إستكشاف",
      "question":"سؤال",
      ...
      "remix-warning":"انتباه! هناك الكثير من المحتوى رهيبة في هذه الدورة، وجعل نسخة سوف يستغرق وقتا طويلا. تأكد من أنك تريد بدء العملية وفي غضون 15 دقيقة سوف تجد نسختك من هذه الدورة التدريبية في ملفك <b>الشخصي.</b>",
      ...
      "bookmarked-success":"ستتم إضافة كل المحتوى الذي تم وضع إشارة مرجعية إليه إلى صفحة التعلم المستقلة.",
      "license":"رخصة",
      "study-now":"ادرس الان",
      "unit":"وحدة",
      "followers":"متابعون",
      ...
      "remix-course-success":"لقد أعدت دورة تدريبية {{courseTitle}}. هل تريد تعديل هذه الدورة التدريبية؟",
   ...
   "index":{
      ...
      "remixDescription":"مجموعات ريميكس وتخصيص المحتوى لتلبية احتياجات الطلاب الخاص بك.",
      "joinUs":"الانضمام إلينا <br/> شرف حق الإنسان في <br/> التعليم",
      "findDescription":"تصفح الآلاف من مجموعات K-12 التي أدلى بها المعلمين، أو البحث على 16M الموارد",
   ...
   "content":{
      ...
      "classes":{
         ...
         "join":{
            ...
            "class-not-found":"لم يتم العثور على سلاسروم. تأكد من إدخال رمز الفصل الدراسي الصحيح",
         ...
         "edit":{
            ...
            "builder":{
               "answer-instructions":{
                  ...
                  "MC":"يمكنك إضافة ما يصل إلى عشرة خيارات للإجابة والإشارة إلى إجابة واحدة صحيحة. حد الحرف: 200.",
                  "OE":"اكتب الإجابة الصحيحة. عدد الأحرف المسموح به: 5000.",
                  "HS_TXT":"يمكنك إضافة ما يصل إلى عشرة خيارات للإجابة وتحديد إجابة صحيحة واحدة أو أكثر.",
               ...
               "question-instructions":{
                  ...
                  "T/F":"اكتب سؤالك.",
                  "FIB":"أثناء كتابة السؤال، استخدم الأقواس لإجابات ملء الفراغ. على سبيل المثال: 'الضربة السيئة [الذئب] فجرت [المنزل].' يمكنك أيضا إضافة صورة.",
                  "HT_RO":"اكتب سؤالك."
               },
      ...
      "modals":{
         ...
         "remove-student":{
            ...
            "data-inaccessible":"سيتم حذف جميع البيانات الخاصة بهم ولا يمكن الوصول إليها من قبلك أو لهم",
            "remove-error":"وجه الفتاة! تعذر إزالة هذا الطالب الآن. الرجاء إعادة المحاولة بعد قليل.",
            "confirmation":"هل تريد بالتأكيد المتابعة؟ يرجى كتابة &quot;حذف&quot; أدناه وانقر على &quot;حذف&quot;.",
      ...
      "resources":{
         "edit":{
            ...
            "best-practices":"<p style=';text-align:right;direction:rtl'> الموارد هي محتوى الوسائط المتعددة بمجموعة متنوعة من الأشكال مثل مقاطع الفيديو، والتفاعلات، ومواقع الويب، والصور، ومستندات غوغل، والمزيد. الحصول على الإبداع واستخدام الموارد الخاصة بك أو الحصول على 'الحيلة' والبحث لدينا امدادات وافرة في غورو. </p><p style=';text-align:right;direction:rtl'> استخدم مجموعة متنوعة من أنواع الموارد لإشراك الطلاب وتضمين السرد حتى تتمكن من المساعدة في توجيه الطلاب من خلال المورد. </p><p style=';text-align:right;direction:rtl'> نوصي بوضع علامات على كل سؤال على المعايير والمعايير الدقيقة ومهارات القرن الحادي والعشرين. يمكنك معرفة كيفية تفاعل الطلاب مع الموارد من خلال لوحة تحكم المعلم. </p>",
            "placeholder-message":"أضف مورد <span>لمعاينته هنا.</span>",
            "not-implemented":"<span>لم يتم تنفيذ</span> معاينة تنسيق الموارد <span>بعد.</span>"
         }
      }
   },
   "user":{
   ...
   "student-landing":{
      ...
      "my-performance":{
         ...
         "title":"تحليل أدائك",
         "primary-text":"اختر الأشياء التي تريد تحليلها وسنقوم بإنشاء تقرير أداء مخصص."
      },
      "browse-featured-courses":"تصفح الدورات لدينا مميزة",
      "current-activity":"النشاط الحالي",
      "learn":"تعلم مع الفصول الدراسية غورو",
      "join-classroom":"الانضمام إلى الفصول الدراسية المعلم الخاص بك لبدء التعلم",
   ...
   "teacher-landing":{
      "class":{
         "class-management-tab":{
            ...
            "performance":"أداء",
            "assessment-min-score":"تقييم الحد الأدنى من النقاط للحصول على الجوائز",
            "assigned-course":"الدورة المعينة",
      ...
      "no-course":"لم يتم تعيين دورة تدريبية لهذا الغرض </br> الفصول الدراسية حتى الآن.",
   ...
   "goals":{
      "manage":{
         ...
         "goals-not-found":"لم يتم تعيين أي أهداف حتى الآن. يمكنك إضافة هدف بالنقر على الزر &quot;إضافة هدف&quot; أعلاه.",
         "status-label":"الحالة",
         "activated":"مفعل"
      },
      "create":{
   ...
   "gru-add-to":{
      ...
      "collections-info":"المجموعات المدرجة هنا <b>لا</b> تنتمي إلى درس آخر أو دورة أخرى",
      "add-to-collection":"إضافة إلى مجموعة",
      "add-to-assessment":"إضافة إلى التقييم أو الجمع",
      "assessments-info":"التقييمات المدرجة هنا <b>لا</b> تنتمي إلى درس آخر أو دورة أخرى",
   ...
   "gru-assessment-confirmation":{
      ...
      "setting-forward-backward":"يمكنك التنقل إلى الأمام وإلى الوراء للإجابة على الأسئلة",
      "cancel":"إلغاء",
   ...
   "gru-welcome-message":{
      ...
      "text-five":"في أي وقت إذا كنت ترغب في العودة إلى الصفحة الرئيسية الخاصة بك، ببساطة انقر على",
      "text-one":"كما يمكنك التحرك في جميع أنحاء الملاح التعلم، ونحن سعداء لدعم رحلتك بالطرق التالية:",
   ...
   "sign-up":{
      ...
      "log-in":"تسجيل الدخول",
      "state":"الدولة أو الإقليم",
      "error-district-message":"يرجى تحديد المنطقة / الميثاق من القائمة أو تقديمها في 'أخرى'.",
   ...
   "forgot-password":{
      ...
      "secondStepDescription-1":"لقد أرسلنا إليك رسالة إلكترونية تتضمن رابطا لإعادة تعيين كلمة المرور.",
      "description":"يحدث لنا جميعا.",
      "secondStepDescription-2":"إذا كان لديك أي أسئلة، يرجى الاتصال",
      "footer-google-description-1":"حاول تسجيل الدخول مرة أخرى عن طريق الضغط على <a href='/sign-in'>'تسجيل الدخول باستخدام غوغل'.</a>",
   ...
   "footer":{
      ...
      "footerDescription":"وتلتزم غورو للحفاظ على منصة مفتوحة المصدر والمجتمع خلق المحتوى CC0.",
      "connect":"الاتصال",
      "events":"أحداث"
   },
   "grade-dropdown":{
   ...
   "player":{
      ...
      "gru-viewer":{
         "not-iframe-url":{
            ...
            "footer_3":"إنشاء ومشاركة المحتوى الخاص بهم. الموارد لديها مجموعة متنوعة من الإعدادات، بما في ذلك",
            "header_1":"لا يمكن عرض هذا المورد ضمن غورو.",
            "footer_2":"الموارد المضافة في غورو تأتي من الآلاف من الناشرين مختلفين الذين",
   ...
   "gru-rubric-creation":{
      ...
      "gru-category":{
         ...
         "category-feedback":"السابق. كما كنت تقوم بمراجعة هذه الفئة، وإيلاء اهتمام دقيق للغرض المؤلف.",
   ...
   "gru-suggest-test":{
      ...
      "resource-lead":"بناء على أدائك في هذه الدورة التدريبية، قد يعزز المورد التالي تفهمك.",
      ...
      "backfill-lead":"استنادا إلى الردود من الاختبار القبلي، قد يكون من المفيد مراجعة مواد إضافية قبل بدء الدرس. مراجعة المواد الداعمة يمكن أن تساعد في إعداد الطلاب لتعلم مواد جديدة.",
      "backfill-header":"المجموعة المقترحة (اختياري)",
      "take":"اتخاذ {{type}}",
      "post-test-lead":"يقترح الاختبار البعدي التالي لقياس فهمك للمعلومات المقدمة. لن يؤثر الاختبار البعدي على درجة أداء الدورة التدريبية.",
      "pre-test-lead":"يقترح اختبار مسبق لقياس فهمك الحالي للمفاهيم في هذا الدرس. يمكن أن يساعدك الاختبار القبلي في إعدادك للمحتوى في الدرس. لن يؤثر الاختبار القبلي على درجة أداء الدورة التدريبية.",
      "end-of-course":"لقد وصلت إلى نهاية الدورة.",
      "benchmark-header":"اختبار معياري (اختياري)",
      "benchmark-lead":"أنت الآن جاهز لإثبات تفهمك من خلال إجراء تقييم معياري. سوف تكسب شارة لإكمال المعيار بنجاح. لن يؤثر المعيار على درجة أداء الدورة."
   }
});
