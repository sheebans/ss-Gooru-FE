...
export default Object.assign(quizzesTranslations, {
  ...
  content: {
    ...
    courses: {
      edit: {
        'assign-to-class': 'ತರಗತಿಗೆ ನಿಯೋಜಿಸಿ',
        'best-practices':
          '[1] ಪಠ್ಯವು ನಿಮ್ಮ ಕಲಿಕೆಯ ವಿಷಯವನ್ನು ಘಟಕಗಳಾಗಿ ಮತ್ತು ಪಾಠಗಳಾಗಿ ಸಂಘಟಿಸಲು ಅನುಮತಿಸುವ ಫೋಲ್ಡರ್ ಆಗಿದೆ. ಒಂದು ಕೋರ್ಸ್ ರಚಿಸುವಾಗ ನೀವು ತಿಳಿಸುವ ಅಗತ್ಯ ಪ್ರಶ್ನೆಗಳನ್ನು, ಕಲಿಕೆಯ ಉದ್ದೇಶಗಳು ಮತ್ತು ನಿಮ್ಮ ವಿಷಯದ ಸಂಘಟನೆಯನ್ನು ಪರಿಗಣಿಸಿ. [2] [3] ನಿಮ್ಮ ವಿದ್ಯಾರ್ಥಿ ಜನರಿಗೆ ವೈವಿಧ್ಯಮಯ ಅನುಭವವನ್ನು ರಚಿಸಲು ನೀವು ಪಾಠಗಳನ್ನು ತುಂಡು ಮಾಡಬಹುದು (ಉದಾಹರಣೆಗೆ, ನೀವು ಅನುಕ್ರಮವಾಗಿ ನಿಮ್ಮ ಘಟಕಗಳು ಕಾಲಾನುಕ್ರಮದಲ್ಲಿ, ವಿಷಯದ ಮೂಲಕ, ಅಥವಾ ಪ್ರಮಾಣಿತವಾಗಿ). [4]',
        information: {
          'course-title': 'ಪಠ್ಯ ಶೀರ್ಷಿಕೆ',
          description: 'ವಿವರಣೆ'
        }
    ...
    modals: {
      ...
      'delete-content': {
        ...
        'content-legend':
          '{1} {{type}} [2] {{index}} - {{parentname}} ನಿಂದ {{title}}',
      ...
      'delete-resource': {
        legend:
          'ನೀವು ಶಾಶ್ವತವಾಗಿ ಅಳಿಸಲು ಬಯಸುತ್ತೀರಿ ಎಂಬುದನ್ನು ದೃಢೀಕರಿಸಿ [1] {{title}} [2]',
        'delete-warning':
          'ಈ {{ಕೌಟುಂಬಿಕತೆ}} ನಲ್ಲಿರುವ ಎಲ್ಲಾ ವಿಷಯಗಳು ಅಳಿಸಲ್ಪಡುತ್ತವೆ',
        'delete-error':
          'ಓಹ್! ಇದೀಗ {{type}} ಅಳಿಸಲು ಸಾಧ್ಯವಿಲ್ಲ. ದಯವಿಟ್ಟು ಶೀಘ್ರದಲ್ಲೇ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.',
      ...
      'remove-content': {
        legend:
          'ನೀವು [1] {{parentname}} [4] ನಿಂದ {{title}} [2] ಅನ್ನು ತೆಗೆದು ಹಾಕಲಿದ್ದೀರಿ.',
        'remove-error':
      ...
      'quick-remove-content': {
        legend:
          '[1] {{title}} [2] ನಿಂದ {{parentname}} [4] ದಿಂದ ತೆಗೆದುಹಾಕಲು ನೀವು ಬಯಸುತ್ತೀರಿ ಎಂದು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ.'
      },
      'quick-delete-content': {
        legend:
          '[1] {{title}} [2] ನಿಂದ {{parentname}} [4] ದಿಂದ ಶಾಶ್ವತವಾಗಿ ಅಳಿಸಲು ನೀವು ಬಯಸುತ್ತೀರಿ.',
  ...
  'student-landing': {
    ...
    'no-classrooms':
      'ನೀವು ಯಾವುದೇ ತರಗತಿ ಕೊಠಡಿಗಳನ್ನು ಇನ್ನೂ ಸೇರಿಲ್ಲ. ನಿಮ್ಮ ಶಿಕ್ಷಕರ ವರ್ಗವನ್ನು ಸೇರಿಸಲು \\\'[1] ತರಗತಿಗೆ ಸೇರಲು\\\' ಕ್ಲಿಕ್ ಮಾಡಿ. ಲೈಬ್ರರಿ ಟ್ಯಾಬ್ನ ಅಡಿಯಲ್ಲಿ ನೀವು ವೈಶಿಷ್ಟ್ಯಗೊಳಿಸಿದ ಪಠ್ಯವನ್ನು ಸಹ ಹುಡುಕಬಹುದು.',
  ...
  'teacher-landing': {
    ...
    'no-classrooms':
      'ನೀವು ಇನ್ನೂ ಯಾವುದೇ ತರಗತಿ ಕೊಠಡಿಗಳನ್ನು ರಚಿಸಿಲ್ಲ. ಲೈಬ್ರರಿ ಟ್ಯಾಬ್ನ ಅಡಿಯಲ್ಲಿ ವೈಶಿಷ್ಟ್ಯಗೊಳಿಸಿದ ಪಠ್ಯಕ್ಕಾಗಿ \\\'ತರಗತಿಯನ್ನು ರಚಿಸು\\\' ಅಥವಾ ಹುಡುಕಾಟವನ್ನು [1] ಕ್ಲಿಕ್ ಮಾಡಿ.',
  ...
  'forgot-password': {
    ...
    'footer-google-description-1':
      '[1] \\"google ನೊಂದಿಗೆ ಸೈನ್ ಇನ್ ಮಾಡಿ\\" ಅನ್ನು ಒತ್ತುವುದರ ಮೂಲಕ ಮತ್ತೊಮ್ಮೆ ಲಾಗಿಂಗ್ ಮಾಡಲು ಪ್ರಯತ್ನಿಸಿ. [2]',
