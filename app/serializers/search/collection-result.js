...
export default DS.JSONAPISerializer.extend({
  ...
  normalizeResponse: function(store, primaryModelClass, payload) {
    ...
    serializer.normalizeCollections(payload.searchResults, collectionModel.data.relationships.collections.data, collectionModel);
  ...
  normalizeCollections: function(searchResults, relationshipItems, collectionModel) {
    const serializer = this;
    for(var i = 0; i < searchResults.length; i++) {
      ...
      serializer.normalizeCollectionResources(result.collectionItems, collection.relationships.resources.data, collectionModel);
      serializer.normalizeCollectionStandards(JSON.parse(result.taxonomyDataSet), collection.relationships.standards.data, collectionModel);
      collectionModel.included.push(collection);
    }
  },

  normalizeCollectionResources: function(collectionItems, relationshipItems, collectionModel) {
  ...
  normalizeCollectionStandards: function(taxonomyDataSet, relationshipItems, collectionModel) {
