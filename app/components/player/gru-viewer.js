...
export default Ember.Component.extend( ConfigurationMixin, {
   ...
   * @property {boolean}
   */
  showFeedback: Ember.computed('collection.showFeedback', 'resourceResult.submittedAnswer', 'showQuestionFeedback', function() {
    let feedback = this.get("showQuestionFeedback") || this.get('collection.showFeedback') === ASSESSMENT_SHOW_VALUES.IMMEDIATE;
    return feedback && this.get('isStudent') && this.get("resourceResult.submittedAnswer");
  }),
