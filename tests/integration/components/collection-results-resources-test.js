...
moduleForComponent('collection-results-resources', 'Integration | Component | collection results resources', {
    integration: true,
    beforeEach: function () {
...
test('collection results resources layout', function(assert) {
    ...
    resources.addObject(Ember.Object.create({ name: "The Three Types of Irony", image:"http://cdn.goorulearning.org/prod1/f000/1436/8540/bed55648-dd9f-4b25-89ad-3b564718a8d9_f8c0ecd1-977e-4f7b-8d31-83e59daf7154.png", type: "interactive"}));
