...
test('Class Navigation', function(assert) {
  ...
  this.render(hbs`{{teacher.class.gru-class-navigation class=class selectedMenuItem='course-map'}}`);
...
test('Toggle header collapse expand click', function(assert) {
  ...
  this.render(hbs`{{teacher.class.gru-class-navigation class='class' onCollapseExpandClicked='toggleHeader'}}`);
  var $navigation = this.$(); //component dom element
