...
moduleForComponent('content/rubric/gru-fixed-footer', 'Integration | Component | content/rubric/gru fixed footer', {
  integration: true
});
...
test('Layout', function(assert) {
  ...
  this.render(hbs`{{content/rubric/gru-fixed-footer footerActions=footerActions}}`);
