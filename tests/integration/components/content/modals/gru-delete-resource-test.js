...
moduleForComponent('content/modals/gru-delete-resource', 'Integration | Component | content/modals/gru delete resource', {
  integration: true,
  beforeEach: function () {
...
test('it renders', function(assert) {
  ...
  assert.equal($component.find('.delete-info ul li:eq(1) label span').text(), this.get('i18n').t('content.modals.delete-resource.second-check').string, 'Incorrect second check warning');
