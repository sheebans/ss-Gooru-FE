...
moduleForComponent('content/gru-image', 'Integration | Component | content/gru image', {
  integration: true,
  beforeEach: function () {
...
test('Layout without image - edit', function (assert) {
  ...
  this.render(hbs`{{content/gru-image isEditing=true srcImage=null editImage=null }}`);
...
test('Layout with image - edit', function (assert) {
  var imageUrl = '/path/image.png';
  this.set('imageUrl', imageUrl);
  this.render(hbs`{{content/gru-image isEditing=true srcImage=imageUrl editImage=imageUrl}}`);
