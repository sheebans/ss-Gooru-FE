...
moduleForComponent('student/gru-performance-course-filter', 'Integration | Component | student/gru performance course filter', {
  integration: true
});
...
test('Layout', function(assert) {
  ...
  this.render(hbs`{{student.gru-performance-course-filter selectedCourse=selectedCourse filterCriteria=filterCriteria}}`);
...
test('Do not show the course tab', function(assert) {
  ...
  this.render(hbs`{{student.gru-performance-course-filter selectedCourse=selectedCourse filterCriteria=filterCriteria showCourse=showCourse}}`);
  ...
  const $courseContentPanel = $performanceFilterPanelBody.find('.content-panel.course');
  assert.notOk($courseContentPanel.hasClass('visible'), 'Course content panel is not visible by default');
