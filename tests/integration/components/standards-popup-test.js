...
moduleForComponent('standards-popup', 'Integration | Component | standards popup', {
  integration: true,
  beforeEach: function () {
...
test('gru-standards-popup', function (assert) {
  ...
  assert.ok($standardsPopupSection.find(".standard-title"), "Missing standard title");
  assert.equal(T.text($standardsPopupSection.find('.standard-title span')), "CCSS.ELA-Literacy.RI.9-10.6", "Incorrect standard title");
