...
moduleForComponent(
  ...
  'Integration | Component | gru teacher featured courses',
  {
    integration: true,
    beforeEach: function() {
...
test('Test for featured courses panel', function(assert) {
  ...
  this.render(hbs`{{gru-teacher-featured-courses courses=courses}}`);

  const $featuredCourses = this.$('.teacher-featured-courses');
