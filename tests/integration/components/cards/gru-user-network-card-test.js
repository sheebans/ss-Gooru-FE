...
test('User Network Card Layout', function(assert) {
  ...
  this.render(hbs`{{cards/gru-user-network-card user=user myFollowings=myFollowings}}`);
  var $component = this.$();
  ...
  T.exists(assert, $userNetworkCard.find(".panel-heading .user-info .district"), "Missing District Name");
  ...
  T.exists(assert, $userNetworkCard.find(".panel-footer .follow-btn button.btn-follow"), "Missing Follow Button");
  assert.equal(T.text($userNetworkCard.find(".panel-footer .follow-btn button.btn-follow")), "Follow", "The label button should be Follow");
});
...
test('User Network Card Layout - if isFollowing', function(assert) {
  ...
  var $component = this.$();
  const $userNetworkCard = $component.find(".gru-user-network-card");
  T.exists(assert, $userNetworkCard.find(".panel-footer .follow-btn button"), "Missing Following Button");
  assert.equal(T.text($userNetworkCard.find(".panel-footer .follow-btn button span.following")), "Following", "The label button should be Following");
});
...
test('User Network Card Layout - Following Filter - unFollow implementation', function(assert) {
  ...
  this.render(hbs`{{cards/gru-user-network-card user=user onUnFollowUser='unFollowUser' myFollowings=myFollowings}}`);
  var $component = this.$();
  const $userNetworkCard = $component.find(".gru-user-network-card");
  var $unFollowButton = $userNetworkCard.find(".panel-footer .follow-btn button");
...
test('User Network Card Layout - Followers Filter - Follow implementation', function(assert) {
  ...
  this.render(hbs`{{cards/gru-user-network-card user=user onFollowUser='followUser' myFollowings=myFollowings}}`);
  var $component = this.$();
  const $userNetworkCard = $component.find(".gru-user-network-card");
