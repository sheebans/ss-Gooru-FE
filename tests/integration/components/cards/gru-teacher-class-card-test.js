...
test('Class Card Layout', function(assert) {
  ...
  this.render(hbs`{{cards/gru-teacher-class-card class=class classStudentCount=classStudentCount}}`);
  ...
  assert.equal(T.text($panelBody.find('.students-info span')), '4 Students', 'Wrong class Student Count');
