...
test('Course Card Layout', function(assert) {
  ...
  T.exists(assert, $cardHeader.find(".image-container"), "Missing course image");
  T.exists(assert, $cardHeader.find(".course-title"), "Missing course card title");
  ...
  T.exists(assert, $cardContent.find(".taxonomy-standards"), "Missing taxonomy standards teaser");
  assert.equal($cardContent.find(".taxonomy-standards .gru-taxonomy-tag").length, 2, 'Wrong taxonomy elements');
  T.exists(assert, $cardContent.find(".course-description"), "Missing course description");
  T.exists(assert, $cardContent.find(".actions .remix-button  button"), "Missing remix button");
  T.notExists(assert, $cardContent.find(".actions .play-button  button"), "Play button should not appear");
  T.exists(assert, $cardContent.find(".visibility .gru-icon"), "Missing visibility icon");
});
...
test('Course Card Layout not show taxonomies', function(assert) {
  ...
  T.notExists(assert, $cardContent.find(".taxonomy-standards"), "taxonomy standards should not be visible");
});
