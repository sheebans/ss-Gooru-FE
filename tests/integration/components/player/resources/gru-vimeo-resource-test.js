...
moduleForComponent('player/resources/gru-vimeo-resource', 'Integration | Component | player/resources/gru vimeo resource', {
  integration: true
});
...
test('Vimeo resource layout', function (assert) {
  ...
  T.exists(assert, $component.find(".gru-vimeo-resource iframe"), "Missing youtube player element");
