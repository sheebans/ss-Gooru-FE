...
test('it renders', function (assert) {
  ...
  assert.equal($firstTierHeader.find('th:eq(0)').text().trim(), this.get('i18n').t('reports.gru-table-view.totals').string, 'First tier: First header is for aggregate values');
