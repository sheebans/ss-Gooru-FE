...
moduleForComponent('reports/assessment/gru-open-ended-questions', 'Integration | Component | reports/assessment/gru open ended questions', {
  integration: true,
  beforeEach: function () {
...
test('Questions Layout', function (assert) {
  ...
  const $component = this.$('.reports.assessment.gru-open-ended-questions');
  ...
  T.exists(assert, $component.find('table th.header.open-ended-question'), 'Missing question header');
