...
test('Members Count with total 1', function(assert) {
  assert.expect(1);
  ...
  this.render(hbs`{{class.gru-class-navigation class=class selectedMenuItem='info'}}`)
  var $component = this.$(); //component dom element
  var $members =$component.find(".members p");
  assert.equal(T.text($members),"1 Student");

});
test('Members Count more than one', function(assert) {
  assert.expect(1);
  ...
  var $component = this.$(); //component dom element
  var $members =$component.find(".members p");
  assert.equal(T.text($members),"2 Students");
...
test('Course Card Unit Count zero', function(assert) {
  ...
  var $component = this.$(); //component dom element
  var $members =$component.find(".members p");
  assert.equal(T.text($members),"0 Students");
});
