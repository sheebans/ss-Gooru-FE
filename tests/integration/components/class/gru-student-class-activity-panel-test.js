...
moduleForComponent('class/gru-student-class-activity-panel', 'Integration | Component | class/gru student class activity panel', {
  integration: true,
  beforeEach: function () {
...
test('Layout', function(assert) {
  ...
  this.render(hbs`{{class.gru-student-class-activity-panel classActivity=classActivity}}`);

  var $component = this.$(); //component dom element
  const $collectionPanel = $component.find('.gru-student-class-activity-panel.panel');
