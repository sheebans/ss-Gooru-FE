...
moduleForComponent('class/analytics/performance/student/gru-student-performance', 'Integration | Component | class/analytics/performance/student/gru performance summary', {
  integration: true,
  beforeEach: function () {
...
test('Test for student performance', function(assert) {
  ...
  const $studentContainer = $component.find(".gru-student-performance-container");
