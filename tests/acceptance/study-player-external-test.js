...
test('Layout', function (assert) {
  visit('/study-player-external?classId=class-for-pochita-as-student&collectionId=first-assessment-id&classId=class-for-pochita-as-student&role=student&source=coursemap&type=assessment-external');

  andThen(function () {
    assert.equal(currentURL(), '/study-player-external?classId=class-for-pochita-as-student&collectionId=first-assessment-id&classId=class-for-pochita-as-student&role=student&source=coursemap&type=assessment-external');
