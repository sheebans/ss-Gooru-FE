...
test('Test data picker options selected', function(assert) {
  ...
  andThen(function() {
    ...
    andThen(function(){
      ...
      T.notExists(assert, $performanceInformation.find('.study-time'), 'Study time item shouldnt be selected at course level');
      ...
      andThen(function(){
        ...
        T.notExists(assert, $unitPerformanceInformation.find('.study-time'), 'Study time item shouldnt be selected at unit level');
