...
test('Teacher Layout', function(assert) {
  ...
  andThen(function() {
    assert.equal(currentURL(), '/teacher/class/class-for-pochita-as-teacher/quick-start');
    ...
    T.exists(assert, $newCourseContainer.find('.actions button.new-course'), 'Missing remix button for new course');
