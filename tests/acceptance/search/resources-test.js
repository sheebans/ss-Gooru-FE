...
test('Apply taxonomy filter', function(assert) {
  visit('/search/resources?taxonomies=["TEKS.K12.SC-K-SIR-01","TEKS.K12.SC-K-SIR-02"]&term=any');

  andThen(function() {
    assert.equal(currentURL(), '/search/resources?taxonomies=%5B%22TEKS.K12.SC-K-SIR-01%22%2C%22TEKS.K12.SC-K-SIR-02%22%5D&term=any');
