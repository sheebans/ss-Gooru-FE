...
moduleFor('adapter:performance/class-unit-performance', 'Unit | Adapter | performance/class-unit-performance', {});
...
test('urlForQueryRecord method for unit class performance', function (assert) {
  ...
  assert.equal(url, '/api/nucleus-insights/v2/class/the-class-id/course/the-course-id/performance', 'Wrong url');
});
