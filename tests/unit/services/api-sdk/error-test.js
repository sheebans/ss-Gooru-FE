...
moduleForService('service:api-sdk/error', 'Unit | Service | api-sdk/error', {
...
test('createError', function(assert) {
  ...
  service.set('errorAdapter', Ember.Object.create({
  ...
  service.set('errorSerializer', Ember.Object.create({
