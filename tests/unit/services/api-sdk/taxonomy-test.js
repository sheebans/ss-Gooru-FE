...
test('fetchCourses', function(assert) {
  ...
  service.set('taxonomyAdapter', Ember.Object.create({
    fetchCourses: function(frameworkId, taxonomySubjectId) {
      assert.deepEqual(frameworkId, 'framework-id', 'Wrong frameworkId value');
      assert.deepEqual(taxonomySubjectId, 'taxonomy-subject-id', 'Wrong taxonomySubjectId value');
      return Ember.RSVP.resolve([]);
    }
  }));
  ...
  var done = assert.async();
  service.fetchCourses('framework-id', 'taxonomy-subject-id')
    .then(function() {
      done();
    });
});
...
test('fetchDomains', function(assert) {
  ...
  service.set('taxonomyAdapter', Ember.Object.create({
    fetchDomains: function(frameworkId, taxonomySubjectId, taxonomyCourseId) {
      assert.deepEqual(frameworkId, 'framework-id', 'Wrong frameworkId value');
      assert.deepEqual(taxonomySubjectId, 'taxonomy-subject-id', 'Wrong taxonomySubjectId value');
      assert.deepEqual(taxonomyCourseId, 'taxonomy-course-id', 'Wrong taxonomyCourseId value');
      return Ember.RSVP.resolve([]);
    }
  }));
  ...
  var done = assert.async();
  service.fetchDomains('framework-id', 'taxonomy-subject-id', 'taxonomy-course-id')
    .then(function() {
      done();
    });
});
...
test('fetchCodes', function(assert) {
  ...
  service.set('taxonomyAdapter', Ember.Object.create({
    fetchCodes: function(frameworkId, taxonomySubjectId, taxonomyCourseId, taxonomyDomainId) {
      ...
      assert.deepEqual(taxonomySubjectId, 'taxonomy-subject-id', 'Wrong taxonomySubjectId value');
      assert.deepEqual(taxonomyCourseId, 'taxonomy-course-id', 'Wrong taxonomyCourseId value');
      assert.deepEqual(taxonomyDomainId, 'taxonomy-domain-id', 'Wrong taxonomyDomainId value');
      return Ember.RSVP.resolve([]);
    }
  }));
  ...
  var done = assert.async();
  service.fetchCodes('framework-id', 'taxonomy-subject-id', 'taxonomy-course-id', 'taxonomy-domain-id')
    .then(function() {
      done();
    });
});
