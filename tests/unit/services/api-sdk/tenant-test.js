...
moduleForService('service:api-sdk/tenant', 'Unit | Service | api-sdk/tenant', {
...
test('findTenantById', function(assert) {
  ...
  service.set('tenantAdapter', Ember.Object.create({
  ...
  service.set('tenantSerializer', Ember.Object.create({
  ...
  service.findTenantById(12345).then(function() { done(); });
});
