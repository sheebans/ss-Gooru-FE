...
test('destroyItem', function (assert) {
  ...
  assert.equal(children2A[0].get('children'), null, "First grandchild -children");
  assert.equal(children2A[0].get('isDestroyed'), true, "First grandchild destroyed");

  assert.equal(children2A[1].get('parent'), null, "Second grandchild -parent");
  assert.equal(children2A[1].get('children'), null, "Second grandchild -children");
  assert.equal(children2A[1].get('isDestroyed'), true, "Second grandchild destroyed");

  assert.equal(children2B[0].get('parent'), null, "Third grandchild -parent");
  assert.equal(children2B[0].get('children'), null, "Third grandchild -children");
  assert.equal(children2B[0].get('isDestroyed'), true, "Third grandchild destroyed");
});
