...
test('merge', function (assert) {
  ...
  var QR6 = QuestionResult.create({resourceId: 'C', 'correct': true, 'timeSpent': 10});
  ...
  reportData.merge([
    UserResourcesResult.create({
      ...
      resourceResults: Ember.A([
        ...
        QuestionResult.create({resourceId: '56a120483b6e7b090501d3e8', 'correct': false, 'reaction': 1, 'timeSpent': 1216, 'userAnswer': 1})
      ])
    }),
    UserResourcesResult.create({
      user: '56983a90fb01fecc328e2388',
      resourceResults: Ember.A([
        QuestionResult.create({resourceId: '56a120483b6e7b090501d3e7', 'correct': false, 'reaction': 5, 'timeSpent': 1216, 'userAnswer': 2})
      ])
    }),
    UserResourcesResult.create({
      user: '56983a906596902edadedc7c',
      resourceResults: Ember.A([
        QuestionResult.create({resourceId: '56a120483b6e7b090501d3e7', 'correct': true, 'reaction': 1, 'timeSpent': 1216, 'userAnswer': 3}),
        QuestionResult.create({resourceId: '56a120483b6e7b090501d3e8', 'correct': true, 'reaction': 1, 'timeSpent': 1216, 'userAnswer': 3}),
        QuestionResult.create({resourceId: '56a120483b6e7b090501d3e9', 'correct': true, 'reaction': 1, 'timeSpent': 1216, 'userAnswer': 3})
      ])
    })
  ]);
  ...
  reportData.merge([
    UserResourcesResult.create({
      ...
      resourceResults: Ember.A([
        QuestionResult.create({resourceId: '56a120483b6e7b090501d3e7', 'correct': false, 'reaction': 1, 'timeSpent': 1216, 'userAnswer': 1}),
        QuestionResult.create({resourceId: '56a120483b6e7b090501d3e8', 'correct': false, 'reaction': 1, 'timeSpent': 1216, 'userAnswer': 1}),
        QuestionResult.create({resourceId: '56a120483b6e7b090501d3e9', 'correct': false, 'reaction': 1, 'timeSpent': 1216, 'userAnswer': 3})
      ])
    }),
    UserResourcesResult.create({
      user: '56983a90fb01fecc328e2388',
      resourceResults: Ember.A([
        QuestionResult.create({resourceId: '56a120483b6e7b090501d3e7', 'correct': false, 'reaction': 1, 'timeSpent': 1216, 'userAnswer': 1}),
        QuestionResult.create({resourceId: '56a120483b6e7b090501d3e8', 'correct': false, 'reaction': 1, 'timeSpent': 1216, 'userAnswer': 2}),
        QuestionResult.create({resourceId: '56a120483b6e7b090501d3e9', 'correct': false, 'reaction': 1, 'timeSpent': 1216, 'userAnswer': 3})
      ])
    }),
    UserResourcesResult.create({
      user: '56983a906596902edadedc7c',
      resourceResults: Ember.A([
        QuestionResult.create({resourceId: '56a120483b6e7b090501d3e7', 'correct': true, 'reaction': 1, 'timeSpent': 1216, 'userAnswer': 2}),
        QuestionResult.create({resourceId: '56a120483b6e7b090501d3e8', 'correct': true, 'reaction': 1, 'timeSpent': 1216, 'userAnswer': 3}),
        QuestionResult.create({resourceId: '56a120483b6e7b090501d3e9', 'correct': true, 'reaction': 1, 'timeSpent': 1216, 'userAnswer': 3})
      ])
    })
