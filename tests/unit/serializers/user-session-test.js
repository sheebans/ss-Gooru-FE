...
test('serializeSessionAssessments', function(assert) {
  ...
  assert.deepEqual(response, expected, 'Wrong response for serializeSessionAssessments');
});
...
test('serializeOpenAssessment', function(assert) {
  ...
  assert.deepEqual(response, expected, 'Wrong response serializeOpenAssessment');
});
