      ...
      'data': [{
        ...
        'attributes': {
          ...
          'teachers': [{
            ...
            'username': 'JeffreyTeacher01',
            'avatarUrl': 'http://profile-qa.s3.amazonaws.com/88638002-deb6-4f8d-b319-4a7ae18d0efe.png'
          }]
        }
      }, {
...
test('normalizeFindRecordResponse', function(assert) {
  ...
  const
    ...
    response = serializer.normalizeFindRecordResponse('any store', 'class/class', payload);
