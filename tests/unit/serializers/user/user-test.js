...
test('normalizeSingleResponse', function(assert) {
  ...
  const
    ...
    response = serializer.normalizeFindRecordResponse('any store', 'user/user', payload);
  ...
  const expected = {
    'data': {
      ...
      'attributes': {
        ...
        'organizationName': 'Gooru',
        'partyUid': '006449b7-fd9a-457b-99b0-98e2cacf1536',
        'avatarUrl': 'http://profile-demo.s3.amazonaws.com/profile-prod/006449b7-fd9a-457b-99b0-98e2cacf1536.png',
        'userRoleSetString': 'User',
        'username': 'developer2',
        'usernameDisplay': 'developer2',
        'viewFlag': 0
...
test('normalizeQueryRecordResponse', function(assert) {
  ...
  const
    ...
    response = serializer.normalizeQueryRecordResponse('any store', 'user/user', payload);
