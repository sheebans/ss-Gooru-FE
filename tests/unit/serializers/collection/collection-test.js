...
test('normalizeSingleResponse for findById', function(assert) {
  ...
  const
    ...
    response = serializer.normalizeSingleResponse('any store', 'collection/collection', payload);
  ...
  assert.deepEqual(response, expected, JSON.stringify(response)+ '\n'+JSON.stringify(expected));
});
...
test('normalizeQueryRecord for findByClassAndCourseAndUnitAndLesson', function(assert) {
  ...
  const
    ...
    response = serializer.normalizeQueryRecordResponse('any store', 'collection/collection', payload);
