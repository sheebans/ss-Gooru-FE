...
test('normalizeFetchLibraries', function(assert) {
  ...
  assert.equal(library1.get('description'), 'description-1', 'Wrong library description');
...
test('normalizeFetchLibraryContent', function(assert) {
  ...
  const normalizedLibraries = serializer.normalizeFetchLibraryContent(contentType, libraryContentPayload);

  assert.equal(normalizedLibraries.get('libraryContent.courses').length, 2, 'Wrong number of courses');
  assert.equal(normalizedLibraries.get('libraryContent.ownerDetails').length, 1, 'Wrong number of ownerDetails');
  ...
  assert.equal(library.get('description'), 'library description', 'Wrong library description');
