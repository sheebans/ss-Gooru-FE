...
test('normalizeFetchCourses', function(assert) {
  ...
  const normalizedCourses = serializer.normalizeFetchCourses(taxonomyCoursesPayload);
...
test('normalizeFetchDomains', function(assert) {
  ...
  const normalizedDomains = serializer.normalizeFetchDomains(taxonomyDomainsPayload);
