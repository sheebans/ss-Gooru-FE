...
test('prepareReportValues', function(assert) {
  ...
  controller.set('collectionPerformanceSummaryItems', Ember.A([Ember.Object.create({attempts: 1,
  ...
  controller.set('collections', Ember.A([Ember.Object.create({
    format: 'assessment',
    id: 'ec2a9b12-93b1-4daf-9c35-3ee86547aada',
    title: 'Assessment Test'
  })]));
  const date = formatDate(new Date(),'MM-DD-YY');
  var fileNameString = createFileNameToDownload(`${controller.get('course.title')}`);
